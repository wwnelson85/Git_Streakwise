...
upload = 'on'
update = 'off'
filename = 'box_scores_2.csv'
person = 'willy'

'''DIRECTORY'''
# establish directory location based on person parameter
directory_willy = '/Users/williamnelson/Documents/streakwise/data_raw/'
directory_sonny = '/Users/sonnynelson/Documents/PyBaseball/'
directoy_sam = '/Users/samnelson1025/PyBaseball/'
...
for active_date in date_string:
    ...
    if (active_date.month >= 3) & (active_date.month <= 10):
        ...
        try:
            ...
            data_collect = data_collect[['date', 'Name', 'type', 'Tm', 'Age', 'G', 'Lev', 'b_2B', 'b_3B', 'b_AB', 'b_BA', 'b_BB', 'b_CS', 'b_GDP', 'b_H', 'b_HBP', 'b_HR', 'b_IBB', 'b_OBP', 'b_OPS', 'b_PA', 'b_R', 'b_RBI', 'b_SB', 'b_SF', 'b_SH','b_SLG','b_SO', 'p_2B', 'p_3B', 'p_AB', 'p_BAbip', 'p_BB', 'p_BF', 'p_CS', 'p_ER', 'p_ERA', 'p_GB/FB','p_GDP', 'p_GS', 'p_H', 'p_HBP', 'p_HR', 'p_IBB', 'p_IP', 'p_L', 'p_LD', 'p_PO', 'p_PU', 'p_Pit', 'p_R', 'p_SB', 'p_SF', 'p_SO', 'p_SO/W', 'p_SO9', 'p_SV', 'p_StL', 'p_StS', 'p_Str', 'p_W', 'p_WHIP']]
